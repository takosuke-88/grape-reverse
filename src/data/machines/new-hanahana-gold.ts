  ...
  seoContent: [
    {
      ...
      paragraphs: [
        "6号機ハナハナシリーズの先鋒として2021年1月に登場した機種だ。設定6の合成は1/141、機械割107%と、後継機のキングハナハナ（110%）やスターハナハナ（110%）と比べると上限がやや控えめな設計になっている。ただし設定1の97%から設定6の107%まで設定間の格差がはっきりしており、設定を入れる店と入れない店で結果がくっきり割れるタイプだ。",
    ...
    },
    {
      ...
      paragraphs: [
        "朝イチは店がやる気のある日かどうかを見抜くことが最優先だ。設定6の合成1/141という数字は、並び待ちの段階から「今日この店は使う気がある」という確信を持てる日にしか狙いに行くべきではない。イベント日でもなく、島全体のデータも平凡な日に<strong>「なんとなく良さそう」で座るのは時間と金の無駄だ</strong>。",
