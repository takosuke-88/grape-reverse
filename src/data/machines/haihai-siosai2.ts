  ...
  seoContent: [
    {
      ...
      paragraphs: [
        "ハイハイシオサイ2は設定1でも合成1/99、設定6で1/83という全設定通じてボーナスが軽い特殊設計のノーマル機だ。この「軽さ」が夕方の台選びにおいて最大の罠になる。",
        "合成が良く見える台が空いていても、それは「ボーナスがよくチカる低設定」を前任者が打ち続けた結果の可能性が高い。低ベース（50枚あたり約32G）という設計上、ボーナスが頻繁にチカっても差枚がなかなか伸びず、「合成は悪くないのに出ていない」という感触になりやすい。",
        "前任者は体感した小役の引きの悪さ、つまりベルやチェリーの落ちが悪かったから見切ったのだ。<strong>夕方の空き台に映る「合成1/90前後」の台は、その見切りの跡である可能性を常に疑うべきだ。</strong>"
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "この機種の厄介な点は、ボーナス確率だけでは設定1〜4の差がほとんど見えないことだ。設定1と設定4の合成差はわずか1/99対1/91。数千ゲーム程度では誤差の範囲だ。頼るべきは設定示唆演出（右虹点滅で設定6確定）とベル確率の逆算になる。",
        "座る前、あるいは打ち出した直後に上部の逆算ツールで差枚・ゲーム数・ボーナス回数を入力し、ベル確率を数値化する。設定6水準のベルが出ているかどうかを確認してから続行判断を下す——この一手間を省いた履歴打ちは、<strong>設定1台を「合成が良いから」と追いかける行為と大差ない</strong>。小役をカウントしたり、逆算でもう1つ理由を増やすのは大切だ。"
      ],
    },
  ],
};
