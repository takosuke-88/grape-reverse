  ...
  seoContent: [
    {
      ...
      paragraphs: [
        "キングハナハナ-30は2023年導入の6号機ノーマルタイプ。設定6の合成1/118.7、機械割110%と、現行ハナハナシリーズの中でも安定したトップクラスのスペックを持つ機種だ。設定差幅は設定1（97%）から設定6（110%）まで13ポイントと広く、設定の強さが結果にダイレクトに反映されやすい。",
        "ベル確率は設定1の1/7.48に対して設定6が1/7.03と数値上の差はあるが、数千ゲーム程度では体感での判断はほぼ不可能だ。判別の核となるのはREG比率とサイドランプの色で、この2点が揃って初めて設定推測に根拠が生まれる。",
        "設定1・2は機械割97〜98%台で、どれだけ打ち込んでも長期プラスは見込めない。<strong>合成が多少軽く見えても、REGが付いてこないなら早めに切り捨てる判断が必須だ。</strong>"
      ]
    },
    {
