  ...
  seoContent: [
    {
      ...
      paragraphs: [
        "スターハナハナ-30は2025年1月にパイオニアが導入した6号機ノーマルタイプで、<strong>現行ハナハナシリーズの中では最も合成が軽い</strong>機種だ。設定6の合成は1/114、機械割は110%と、6号機ハナハナシリーズの中でもトップクラスのスペックを誇る。REG確率は設定1の1/387から設定6の1/242まで大きく乖離しており、終日打ち込めば設定差がREG回数にハッキリ現れやすい設計になっている。",
