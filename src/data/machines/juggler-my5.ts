...
export const myJuggler5Config: MachineConfig = {
  ...
  detailedProbabilities: {
    big_solo: [422.8, 417.4, 407.1, 383.3, 358.1, 334.4],
    big_cherry: [1456.4, 1424.7, 1394.4, 1365.1, 1336.8, 1285.0],
    reg_solo: [655.4, 601.3, 508.0, 417.4, 390.1, 334.4],
    reg_cherry: [1092.3, 1074.4, 993.0, 949.8, 862.3, 728.2],
  },
};
