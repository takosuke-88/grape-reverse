...
export const myJuggler5Config: MachineConfig = {
  ...
  detailedProbabilities: {
    big_solo: [420.1, 414.8, 404.5, 381.0, 356.1, 334.4],
    big_cherry: [1365.3, 1365.3, 1365.3, 1337.5, 1285.0, 1285.0],
    reg_solo: [655.4, 595.8, 496.5, 404.5, 364.1, 334.4],
    reg_cherry: [1092.3, 1092.3, 1040.3, 1024.0, 1024.0, 728.2],
  },
};
