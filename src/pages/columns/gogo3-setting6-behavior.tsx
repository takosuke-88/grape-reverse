...
const Gogo3Setting6BehaviorColumn = () => {
  return (
        ...
        <div className="prose dark:prose-invert max-w-none leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div className="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm text-center">
              ...
              <div className="text-xl font-bold text-red-600 dark:text-red-400">+1,358枚</div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm text-center">
              <div className="text-gray-500 dark:text-gray-400 text-xs mb-1">平均投資</div>
              <div className="text-xl font-bold text-gray-800 dark:text-gray-100">7,230円</div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm text-center">
              <div className="text-gray-500 dark:text-gray-400 text-xs mb-1">機械割(シミュ値)</div>
              <div className="text-xl font-bold text-gray-800 dark:text-gray-100">107.81%</div>
            </div>
            <div className="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm text-center">
              <div className="text-gray-500 dark:text-gray-400 text-xs mb-1">勝率</div>
              <div className="text-xl font-bold text-blue-600 dark:text-blue-400">82.75%</div>
            </div>
          </div>
          ...
          <h3 className="text-lg font-bold mt-8 mb-4">何枚以上取れる確率はどれくらいか</h3>
          <p className="mb-6">
          ...
          <div className="overflow-x-auto my-6 rounded-xl border border-gray-200 dark:border-gray-700">
            <table className="min-w-full text-sm text-left border-collapse">
              <thead className="bg-gray-100 dark:bg-gray-800">
                <tr>
                  <th className="px-4 py-3 border-b dark:border-gray-700 font-bold">比較項目</th>
                  <th className="px-4 py-3 border-b dark:border-gray-700 font-bold text-center">ゴージャグ3 設定6</th>
                  <th className="px-4 py-3 border-b dark:border-gray-700 font-bold text-center">スマスロGOD神々の軌跡 設定6</th>
                </tr>
              </thead>
              <tbody>
                <tr className="bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-700">
                  <td className="px-4 py-4 font-bold">機械割</td>
                  <td className="px-4 py-4 text-center">107.81%</td>
                  <td className="px-4 py-4 text-center">114.6%</td>
                </tr>
                <tr className="bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-700">
                  <td className="px-4 py-4 font-bold">初当り/合算</td>
                  <td className="px-4 py-4 text-center">合算1/117.4</td>
                  <td className="px-4 py-4 text-center">AT初当り1/295</td>
                </tr>
                <tr className="bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-700">
                  <td className="px-4 py-4 font-bold">出玉仕様</td>
                  <td className="px-4 py-4 text-center">Aタイプ(BIG約240枚/REG約96枚)</td>
                  <td className="px-4 py-4 text-center">純増約7.0枚/G</td>
                </tr>
                <tr className="bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-700">
                  <td className="px-4 py-4 font-bold">勝率</td>
                  <td className="px-4 py-4 text-center">82.75%</td>
                  <td className="px-4 py-4 text-center">約63%</td>
                </tr>
                <tr className="bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-700">
                  <td className="px-4 py-4 font-bold">1日の波</td>
                  <td className="px-4 py-4 text-center">安定（最大マイナス約4,500枚）</td>
                  <td className="px-4 py-4 text-center">荒波（万枚超え〜マイナス7,000枚級まで）</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <h3 className="text-lg font-bold mt-8 mb-4">平均投資額の違い</h3>
          <p className="mb-6">
          ...
          <h3 className="text-lg font-bold mt-8 mb-4">どちらを選ぶか</h3>
          <p className="mb-6">
          ...
          <ColumnNavigation currentId="gogo3-setting6-behavior" />
        </div>
      </main>
    </div>
  );
...
export default Gogo3Setting6BehaviorColumn;
