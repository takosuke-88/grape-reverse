      ...
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            実はそれ、運が悪かったのではなく、
            <strong>「最初から設定1だった」</strong>可能性が高いです。
          </p>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            この記事では、AIシミュレーションと大量の実戦データを分析し、
            <strong>「なぜボーナス確率だけで判別してはいけないのか」</strong>
            、そして<strong>「どうすれば設定6を掴めるのか」</strong>
            を数学的に解説します。
          </p>
          ...
          <div className="my-8 p-6 bg-blue-50 dark:bg-gray-800 rounded-lg border border-blue-100 dark:border-gray-700">
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
              <li>
                ...
                の確率で「設定6っぽい挙動」をする（誤爆）。
              </li>
              <li>
                設定6でも、<strong>12〜18%</strong>
                の確率で「設定1以下」に沈む（不発）。
              </li>
              <li>
                3000G程度では、ボーナス合算だけ見ても設定は
                <strong>全く分からない</strong>。
              </li>
              <li>
                唯一の頼みの綱は<strong>「ぶどう確率」</strong>だけである。
              </li>
            </ul>
          </div>
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            実は、
            <strong>
              設定1（機械割97%）を3000回転回した時、約10回に1回はこのような「設定6以上の数値」になってしまう
            </strong>
            のです。
          </p>
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            つまり、ホールにある「合算が良い台」の10台中1〜2台は、ただの
            <strong>「上振れした設定1」</strong>なのです。
            <br />
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ボーナス確率がこれだけ荒れる中で、唯一「嘘をつきにくい」のが小役である
            <strong>ぶどう確率</strong>です。
          </p>
          <ul className="list-disc pl-5 space-y-2 mb-6 text-gray-700 dark:text-gray-300">
            <li>
              <strong>設定1：</strong> 1/5.90
            </li>
            <li>
              <strong>設定6：</strong> 1/5.66
            </li>
          </ul>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            「たった0.24の差？」と思うかもしれません。しかし、分母が小さいため、3000回転もすれば
            <strong>約500回</strong>も抽選を受けられます。
            <br />
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ここが重要です。台の「総回転数」「BIG回数」「REG回数」そして
            <strong>「現在の差枚数（スランプグラフから読み取る）」</strong>
            をツールに入力してください。
          </p>
          ...
          <ul className="list-disc pl-5 space-y-2 mb-6 text-gray-700 dark:text-gray-300">
            <li>
              <strong>1/5.7 前後なら：</strong>{" "}
              打ち始め推奨！「本物の高設定」の可能性が高いです。
            </li>
            <li>
              <strong>1/6.0 以下なら：</strong>{" "}
              危険信号。それは「上振れした設定1」かもしれません。触らないのが無難です。
            </li>
          </ul>
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <br />
            しかし、<strong>「ボーナス確率 ＋ ぶどう確率」</strong>
            の両方が良い台は、設定6の信頼度が飛躍的に上がります。
          </p>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
