    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="prose dark:prose-invert max-w-none leading-relaxed">
          {/* 導入 */}
          <p className="mb-4">
            ファンキージャグラー2の設定6って、実際どんな挙動をするか知ってますか？
            <br />
          ...
          <p className="mb-4">
            でも、私には苦い経験があるんです。
            <br />
            「今日はBIG絶好調！設定6間違いなし！」そう確信して打ち続けた結果…。
            <br />
          ...
          <p className="mb-4">
            いきなりショッキングなことを言います。
            <strong>BIG確率だけで設定6を判別するのは、ほぼ不可能です。</strong>
          </p>
            ...
            <table className="min-w-full text-sm text-left border border-gray-300 dark:border-gray-700">
              ...
              <tbody>
                ...
                <tr className="bg-purple-50 dark:bg-gray-800 font-bold">
                  ...
                  <td className="px-4 py-2 border-b dark:border-gray-700 text-purple-600 dark:text-purple-300">
                    1/219
                  </td>
                </tr>
              </tbody>
          ...
          <p className="mb-4">
            正直、そこまで大きな差がないんですよね。料理に例えるなら
            <strong>「隠し味」程度の違い</strong>
            です。塩をひとつまみ足したかどうか、くらい。
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            じゃあ、何を見ればいいのか？答えは<strong>「単独REG」</strong>です。
            <br />
            これに設定差の塊が詰まってるんですよね。
          </p>
          ...
          <p className="mb-4">
            1.4倍近い差があります。例えるなら、同じ距離を走るのに
            <strong>設定6は下り坂、設定1は上り坂</strong>
            。体感できるレベルで違います。
          </p>
          <div className="bg-yellow-50 dark:bg-yellow-900/30 p-4 rounded-lg border border-yellow-200 dark:border-yellow-700 my-4">
            ...
            <p className="text-sm">
              データ機では「単独」か「チェリー重複」か見抜けないことが多いです。でも、打っているあなたなら分かりますよね？
              <br />
              <strong>レバーオンでGOGO! → 単独</strong>
              です。これをスマホのメモ帳などで必ずカウントしましょう。
            </p>
          </div>
          ...
          <p className="mb-4">
            もう一つ、見逃せない数字があります。<strong>ぶどう確率</strong>
            です。
          </p>
          ...
          <p className="mb-4">
            「たった0.25の差？」と思うかもしれませんが、月に数回打つなら年間で
            <strong>14万円以上の差</strong>になります。
          </p>
          <p className="mb-8">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-xl mt-10">
            ...
            <ul className="list-disc pl-5 space-y-2 mb-6">
              ...
              <li>
                <strong>単独REG確率</strong>が最重要（1/460 vs 1/330）
              </li>
