...
<div class="not-prose">
<p class="text-gray-700 dark:text-gray-300 mb-4 font-semibold italic">
...
<div class="space-y-8 bg-slate-100 dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 mb-10">
  <div>
    ...
    <p class="text-gray-700 dark:text-gray-300 pl-8">
  ...
  <div>
    ...
    <p class="text-gray-700 dark:text-gray-300 pl-8">
      設定1と6には合算・ベル確率に明確な差がある。早い段階で見切りをつける材料になる。
      <strong class="text-gray-900 dark:text-white">当ページ上部にある逆算ツール</strong>
      を使えば、リアルタイムで設定推測ができる。打ちながら確認する習慣をつけておくだけで、損切りのタイミングが大きく変わる。
    </p>
  </div>
