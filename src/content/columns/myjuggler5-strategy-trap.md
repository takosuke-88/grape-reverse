...
<blockquote class="border-l-4 border-purple-500 bg-purple-50 dark:bg-purple-900/20 p-4 mb-8 italic text-slate-700 dark:text-slate-300 shadow-sm rounded-r-lg">
  <p class="lead text-lg m-0 text-gray-800 dark:text-gray-200">
...
<ul class="list-disc pl-5 space-y-2 mb-6 text-gray-700 dark:text-gray-300">
  <li><strong>設定5 (チェリー狙い): <span class="text-purple-600 dark:text-purple-400 font-bold">106.45%</span></strong></li>
  <li><strong>設定6 (チェリー狙い): <span class="text-purple-600 dark:text-purple-400 font-bold">110.61%</span></strong></li>
</ul>
</div>
...
<br />
<strong class="text-purple-600 dark:text-purple-400 text-xl block my-4 text-center">「設定2を早めに見切ること」</strong>
それだけ。
