...
<nav class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-8 overflow-x-auto whitespace-nowrap pb-2">
  ...
  <span>/</span>
  <span class="text-slate-900 dark:text-slate-100 font-medium truncate">来店演者の考察</span>
</nav>
...
<div class="not-prose">
<p class="mb-6 leading-loose italic text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border-l-2 border-slate-200 dark:border-slate-700">
...
<div class="not-prose">
<p class="mb-6 leading-loose font-bold text-lg text-indigo-600 dark:text-indigo-400">
